...
1. testMoney.cpp - the main test driver that handles reading in the command and calling the appropriate money method
2. Money.cpp - the Money class which is where you will place all of your code
2.1 Money.h - the Money class header file
